...
-- Data input settings
cmd:option('-input_h5','/datacenter/storytelling/dataset/storytelling.h5','path to the h5file containing the preprocessed dataset')
cmd:option('-input_json','/datacenter/storytelling/dataset/storytelling.json','path to the json file containing additional info and vocab')
...
local function lossFun()
  ...
  -----------------------------------------------------------------------------
  -- get batch of data  
  local data = loader:getBatch{batch_size = opt.batch_size, split = 'train', seq_per_img = opt.seq_per_img, images_use_per_story = opt.images_use_per_story}
